...
public class TesterDonald {
    ...
    public static void ChoiceMessage1(){
        ...
        System.out.println("4 - Scalers");//M-zw
        System.out.println("5 - K-Nearest Neighbors(k-nn)");//N-zc
        System.out.println("6 - Generate charts");//O-dm
        System.out.println("7 - Convert file type to (.json) ");//P-zc
        System.out.println("8 - Web scraping ");//Q-dm
    ...
    public static void ChoiceMessage_sAsB(){
        ...
        System.out.println("1 - Obtain data using range of row");//I-zw
        System.out.println("2 - Obtain data using certain column");//J-zw
        System.out.println("(-1) - Back to previous step");
        System.out.println("Enter step to proceed(1/2): ");
    ...
    public static void ChoiceMessageS(){
        ...
        System.out.println("1 - Get overall statistics");//K-jy
        System.out.println("2 - Fill missing values");//L-zw
        System.out.println("(-1) - Back to previous step");
        System.out.println("Enter step to proceed(1/2): ");
    ...
    public static void AreYouSureMessage(){
        System.out.println("Are you sure you want to proceed? If YES please enter (1).If NO please enter (-1) to back to the previous step:");
        aus=group11.nextInt();
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("=============================================");
        System.out.println("         Welcome Data Science Journey         ");
        System.out.println("=============================================");
        System.out.println("This system is to help Donald on his Data Science journey");//add itroduction here!!
        ChoiceMessage1();
        System.out.println("");
        do{
          if(step==1){
